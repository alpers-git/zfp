#ifndef SYCLZFP_ENCODE3_H
#define SYCLZFP_ENCODE3_H
...
/*
DPCT1110:3: The total declared local variable size in device function cudaEncode
...
void syclEncode(const uint maxbits, const Scalar *scalars, Word *stream,
                ...
                const sycl::nd_item<3> &item_ct1, unsigned char *perm_3d,
    ...
    q_ct1.submit([&](sycl::handler &cgh) {
      ...
      cgh.parallel_for(sycl::nd_range<3>(grid_size * block_size, block_size),
                       [=](sycl::nd_item<3> item_ct1) {
                         syclEncode<Scalar>(maxbits, d_data, stream, dims,
