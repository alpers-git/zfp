...
public:
  ...
  void flush(void* stream = 0) const
  {
  ...
  // inspector
  Scalar get(size_t i, size_t j, size_t k, size_t l, void* stream = 0) const
  {
    const CacheLine* p = line(i, j, k, l, false, stream);
    return (*p)(i, j, k, l);
  }

  // mutator
  void set(size_t i, size_t j, size_t k, size_t l, Scalar val, void* stream = 0)
  {
    CacheLine* p = line(i, j, k, l, true, stream);
    (*p)(i, j, k, l) = val;
  }
...
protected:
  ...
  CacheLine* line(size_t i, size_t j, size_t k, size_t l, bool write, void* stream = 0) const
  {
    CacheLine* p = 0;
