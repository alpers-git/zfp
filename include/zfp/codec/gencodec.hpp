...
protected:
  ...
  size_t encode_block(bitstream_offset offset, const ExternalType* block, void* stream = 0) const
  {
  ...
  size_t decode_block(bitstream_offset offset, ExternalType* block, void* stream = 0) const
  {
...
public:
  ...
  size_t encode_block(bitstream_offset offset, uint shape, const ExternalType* block, void* stream = 0) const
  {
  ...
  size_t decode_block(bitstream_offset offset, uint shape, ExternalType* block, void* stream = 0) const
  {
