#ifndef SYCL_ZFP_DECODE_H
#define SYCL_ZFP_DECODE_H
...
public:
  ...
  uint64 read_bits(const uint &n_bits)
  {
    ...
    int first_read = dpct::min(rem_bits, n_bits);
    // first mask 
...
#if (DPCT_COMPAT_RT_VERSION < 8000)
#pragma unroll
#else
    #pragma unroll size
#endif
...
/*
DPCT1110:4: The total declared local variable size in device function zfp_decode
