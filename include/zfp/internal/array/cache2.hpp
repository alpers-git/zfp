...
public:
  ...
  // inspector
  Scalar get(size_t i, size_t j, void* stream = 0) const
  {
  ...
  // mutator
  void set(size_t i, size_t j, Scalar val, void* stream = 0)
  {
...
protected:
  ...
  CacheLine* line(size_t i, size_t j, bool write, void* stream = 0) const
  {
    CacheLine* p = 0;
